...
// 134
console.log(lab1.questionOne([2, 1, 3])); 
// 14
console.log(lab1.questionOne([5, 10, 9])); 
// 206
console.log(lab1.questionOne([2, 5, 6])); 
// 65
console.log(lab1.questionOne([1, 3, 4])); 
// 26
console.log(lab1.questionOne([7, 8, 9,10])); 
// 294
console.log(lab1.questionOne([1, 1, 1, 1, 1])); 
// 5
...
console.log(lab1.questionThree("Hello my name is Owen")); 
// 7
